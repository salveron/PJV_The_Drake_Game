...
import thedrake.game.actions.ShiftAction;
import thedrake.game.actions.SlideAction;
import thedrake.game.actions.StrikeAction;
...
public class StandardDrakeSetup {
    ...
    public GameState startState(Board board) {
        List<Troop> stack = Arrays.asList(DRAKE, CLUBMAN, CLUBMAN, MONK, SPEARMAN, SWORDSMAN, ARCHER);
